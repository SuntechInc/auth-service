...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/dev/Documentos/trabalhos/suntech/auth-service/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/dev/Documentos/trabalhos/suntech/auth-service/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:postgres@localhost:5433/auth_db?schema=public"
      }
    }
  },
